...
var require_default_theme = __commonJS({
  "node_modules/tailwindcss/dist/default-theme.js"(exports, module) {
    ...
    var i = /[+-]?\d*\.?\d+(?:[eE][+-]?\d+)?/;
    var I = new RegExp(`^${i.source}$`);
    var F = new RegExp(`^${i.source}%$`);
    var $ = new RegExp(`^${i.source}s*/s*${i.source}$`);
    var C = ["cm", "mm", "Q", "in", "pc", "pt", "px", "em", "ex", "ch", "rem", "lh", "rlh", "vw", "vh", "vmin", "vmax", "vb", "vi", "svw", "svh", "lvw", "lvh", "dvw", "dvh", "cqw", "cqh", "cqi", "cqb", "cqmin", "cqmax"];
    var H = new RegExp(`^${i.source}(${C.join("|")})$`);
    var S = ["deg", "rad", "grad", "turn"];
    var P = new RegExp(`^${i.source}(${S.join("|")})$`);
    var q = new RegExp(`^${i.source} +${i.source} +${i.source}$`);
    function l(e) {
      let c = Number(e);
    ...
    var a = s((e) => {
      if (l(e.value)) return `${e.value}px`;
    });
    var b = s((e) => {
      if (l(e.value)) return `${e.value}ms`;
    });
    var p = s((e) => {
      if (l(e.value)) return `${e.value}deg`;
    });
    var A = s((e) => {
    ...
    var y = s((e) => {
      if (l(Number(e.value))) return `repeat(${e.value}, minmax(0, 1fr))`;
    });
