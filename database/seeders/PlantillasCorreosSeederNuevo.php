...
class PlantillasCorreosSeederNuevo extends Seeder
{
    /**
...
<div style="background-color: #f8f9fa; border-left: 4px solid #667eea; padding: 15px; margin: 20px 0; border-radius: 4px;">
    ...
    <div style="padding: 8px 0; border-bottom: 1px solid #e0e0e0;">
        ...
        <span style="color: #667eea; font-weight: bold; float: right;">{{total_clases}}</span>
        <div style="clear: both;"></div>
    </div>
    <div style="padding: 8px 0; border-bottom: 1px solid #e0e0e0;">
        <span style="font-weight: bold; color: #555;">Clases No Realizadas:</span>
        <span style="color: #667eea; font-weight: bold; float: right;">{{clases_no_realizadas}}</span>
        <div style="clear: both;"></div>
    </div>
    <div style="padding: 8px 0;">
        <span style="font-weight: bold; color: #555;">Porcentaje de Cumplimiento:</span>
        <span style="color: #667eea; font-weight: bold; float: right;">{{porcentaje}}%</span>
        <div style="clear: both;"></div>
    </div>
</div>
...
<div style="background-color: #fff3f3; border: 2px solid #ff6b6b; border-radius: 8px; padding: 20px; margin: 20px 0;">
    <h3 style="color: #c92a2a; margin-top: 0;">⚠️ Atención Requerida</h3>
    ...
    <p style="color: #c92a2a; font-weight: bold; font-size: 16px;">Porcentaje de cumplimiento: {{porcentaje}}%</p>
</div>
...
Equipo Académico',
        ...
        PlantillaCorreo::create([
            ...
            'contenido_html' => '<h2>Hola {{nombre}},</h2>
...
<p>Saludos,<br>Equipo Académico</p>',
...
Equipo Académico',
        ...
        $this->command->info('✓ Plantillas de correos actualizadas exitosamente');
    }
}
