...
<aside
    class="fixed inset-y-0 left-0 z-10 flex flex-col space-y-6 shadow-md bg-light-cloud-blue dark:bg-dark-eval-1 shadow-gray-500/30"
    :class="{
    ...
    style="transition-property: width, transform; transition-duration: 150ms; top: 2rem;" 
