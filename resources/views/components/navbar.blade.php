<nav aria-label="secondary" x-data="{ open: false }"
    ...
    <div class="flex items-center gap-3">
        ...
        <!-- Botón Acciones Rápidas - Solo para administradores -->
        @can('admin panel')
            <a href="{{ route('quick-actions.index') }}" 
               class="hidden md:inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors duration-200"
