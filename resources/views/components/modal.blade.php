...
<div
    x-data="modalComponent({ show: @js($show), focusable: {{ $attributes->has('focusable') ? 'true' : 'false' }} })"
    x-init="init()"
    x-show="show"
    @open-modal.window="handleOpen($event, '{{ $name }}')"
    @close.stop="show = false"
    @keydown.escape.window="show = false"
    @keydown.tab.prevent="navigateFocus($event)"
