<x-app-layout>
    ...
    <div class="p-6 bg-white rounded-lg shadow-lg">
        ...
        <div class="flex items-center justify-between mb-6">
            <div class="w-2/3">
                <input type="text" id="searchInput" onkeyup="searchTable()" placeholder="Buscar por ID, Nombre o Facultad"
    ...
    <script>
        function searchTable() {
            ...
            for (var i = 1; i < rows.length; i++) {
                ...
                var facultad = cells[2].textContent.toLowerCase();

                if (id.includes(input) || nombre.includes(input) || facultad.includes(input)) {
