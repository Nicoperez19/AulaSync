    ...
    @if (count($pisos) > 0)
        ...
        <div class="flex-1 min-h-0 bg-white shadow-md rounded-xl overflow-hidden relative">
                                        ...
                                        <div class="overflow-auto">
                                            <table class="min-w-full divide-y divide-gray-200">
                                                <thead class="bg-gray-50 sticky top-0 z-10">
                                                    <tr>
                                                        <th
                                                            class="w-16 px-2 py-2 font-medium text-left text-gray-500 uppercase text-xs">
                                                            Espacio</th>
                                                        <th
                                                            class="w-24 px-2 py-2 font-medium text-left text-gray-500 uppercase text-xs">
                                                            Nombre</th>
                                                        <th
                                                            class="w-16 px-2 py-2 font-medium text-center text-gray-500 uppercase text-xs">
                                                            Estado</th>
                                                        <th
                                                            class="px-2 py-2 font-medium text-left text-gray-500 uppercase text-xs">
                                                            Clase Actual</th>
                                                    </tr>
                                                </thead>
                                                <tbody class="bg-white divide-y divide-gray-200">
                                                    @foreach (array_slice($espaciosPiso, 0, ceil(count($espaciosPiso) / 2)) as $espacio)
                                                        ...
                                                        @endphp
                                                        <tr
                                                            class="{{ $colorFila }} hover:{{ str_replace('bg-50', 'bg-100', $colorFila) }} transition-colors duration-200">
                                                            <td
                                                                class="px-2 py-2 font-bold text-left text-blue-700 text-sm">
                                                                {{ $espacio['id_espacio'] }}
                                                            </td>
                                                            ...
                                                            <td class="px-2 py-2 text-left">
                                                                ...
                                                                @else
                                                                    <span class="text-gray-400 text-xs italic">Sin
                                                                        clase</span>
                                                                @endif
                                                            </td>
                                                        </tr>
                        ...
                        @else
                            <div class="h-full flex items-center justify-center">
                                <div class="text-center">
                                    <i class="fa-solid fa-building text-4xl text-gray-300 "></i>
            ...
            @else
                ...
                <div class="h-full flex items-center justify-center">
                    <div class="text-center">
                        <i class="fa-solid fa-clock text-4xl text-gray-300 "></i>
