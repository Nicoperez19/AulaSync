<div>
    ...
    <!-- Barra de acciones superiores (Eliminar seleccionados) -->
    <div class="mb-4 flex justify-end">
        @if (count($selected) >= 2)
            <button type="button" onclick="confirmDeleteSelected()" class="flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-bold text-white bg-red-700 hover:bg-red-800 rounded-lg shadow-sm hover:shadow transition duration-150 shrink-0 w-full sm:w-auto">
