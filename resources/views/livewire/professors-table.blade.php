    ...
    <div class="flex flex-col gap-4 mb-4 md:flex-row md:items-center md:justify-between">
        <div class="relative w-full md:w-1/2">
            ...
            <input type="text"
                   ...
                   placeholder="Buscar por RUN, Nombre, Email, Tipo, Carrera, Facultad o Sede..."
        ...
        <div class="flex items-center text-sm text-gray-500 dark:text-gray-400">
            <span>Total: <strong>{{ $profesores->total() }}</strong> profesores</span>
        </div>
    </div>
        ...
        <table id="professors-table" class="w-full text-sm text-center border-collapse table-auto min-w-max">
            ...
            <tbody>
                @forelse ($profesores as $index => $profesor)
                    <tr wire:key="profesor-row-{{ $profesor->run_profesor }}" class="{{ $index % 2 === 0 ? 'bg-white' : 'bg-gray-50' }}">
                                <td
                ...
                @empty
                    <tr wire:key="empty-professors-row">
