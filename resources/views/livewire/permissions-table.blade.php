    ...
    <div class="flex flex-col gap-4 mb-4 md:flex-row md:items-center md:justify-between">
        <div class="relative w-full md:w-1/2">
            ...
            <input type="text"
                   ...
                   placeholder="Buscar por Nombre de Permiso o ID..."
        ...
        <div class="flex items-center text-sm text-gray-500 dark:text-gray-400">
            <span>Total: <strong>{{ $permissions->total() }}</strong> permisos</span>
        </div>
    </div>
        ...
        <table id="permissions-table" class="w-full text-sm text-center border-collapse table-auto min-w-max">
            ...
            <tbody>
                @forelse ($permissions as $index => $permission)
                    <tr wire:key="permission-row-{{ $permission->id }}" class="{{ $index % 2 === 0 ? 'bg-white' : 'bg-gray-50' }}">
                        <td
                ...
                @empty
                    <tr wire:key="empty-permissions-row">
