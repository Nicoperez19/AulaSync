...
<body class="font-sans antialiased bg-gradient-to-br  min-h-screen">
    <div class="min-h-screen flex flex-col">
        ...
        <main class="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-8 {{ $step === 6 ? '!p-0 !container-none !max-w-full' : '' }}">
            <!-- Step Indicators (solo mostrar despu茅s del paso 0) -->
            @if($step > 0 && $step !== 5)
            <div class="max-w-4xl mx-auto mb-8">
                <!-- Fila de c铆rculos y l铆neas -->
                <div class="flex items-center justify-between mb-3">
                    @php
                        $steps = [
                            1 => ['icon' => 'fa-user-plus', 'title' => 'Administrador'],
                            2 => ['icon' => 'fa-image', 'title' => 'Logo'],
                            3 => ['icon' => 'fa-building', 'title' => 'Informaci贸n'],
                            4 => ['icon' => 'fa-upload', 'title' => 'Carga Masiva'],
                            5 => ['icon' => 'fa-calendar', 'title' => 'Per铆odos'],
                    ...
                    @foreach($steps as $stepNum => $stepInfo)
                        ...
                        <!-- L铆nea conectora (excepto despu茅s del 煤ltimo paso) -->
                        @if($stepNum < 6)
