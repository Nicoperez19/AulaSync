...
<div class="p-8">
    <div class="text-center mb-8">
        ...
        <h2 class="text-2xl font-bold text-gray-800">Informaci&oacute;n de la Sede</h2>
        <p class="text-gray-600 mt-2">Confirme y complete la informaci&oacute;n de su sede</p>
    </div>
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="prefijo_espacios" id="prefijo_espacios" 
                       ...
                       maxlength="10"
                       placeholder="Ej: TH (para Talcahuano), CT (para Ca&ntilde;ete)"
                       required>
                <p class="text-sm text-gray-500 mt-1">
                    Este prefijo se utilizar&aacute; para identificar las salas y espacios de esta sede.
                </p>
            </div>

            <div>
                <label for="descripcion" class="block text-sm font-medium text-gray-700 mb-2">
                    <i class="fas fa-align-left mr-2"></i>Descripci&oacute;n (Opcional)
                </label>
                <textarea name="descripcion" id="descripcion" rows="3"
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                          placeholder="Breve descripci&oacute;n de la sede">{{ old('descripcion', $sede->descripcion ?? '') }}</textarea>
            </div>

            <div>
                <label for="direccion" class="block text-sm font-medium text-gray-700 mb-2">
                    <i class="fas fa-map-marker-alt mr-2"></i>Direcci&oacute;n (Opcional)
                </label>
                <input type="text" name="direccion" id="direccion" 
                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                       value="{{ old('direccion', $sede->direccion ?? '') }}"
                       placeholder="Direcci&oacute;n f&iacute;sica de la sede">
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label for="telefono" class="block text-sm font-medium text-gray-700 mb-2">
                        <i class="fas fa-phone mr-2"></i>Tel&eacute;fono (Opcional)
                    </label>
