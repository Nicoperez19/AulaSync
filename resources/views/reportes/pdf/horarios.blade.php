...
<head>
    ...
    <title>An谩lisis de Horarios</title>
    <style>
        body {
...
<body>
    ...
    <div class="info-filtros">
        <strong>Rango de M贸dulos:</strong> {{ $moduloInicio }} - {{ $moduloFin }}<br>
        <strong>Total de M贸dulos:</strong> {{ $modulosDia }}
    </div>
