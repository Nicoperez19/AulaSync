...
<head>
    ...
    <title>An谩lisis de Espacios</title>
    <style>
        body {
...
<body>
    ...
    <table>
        ...
        <div class="header">
            ...
            <p>Solo se muestran las salas con menor porcentaje de ocupaci贸n</p>
        </div>
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                @php
                    // Filtrar las salas menos ocupadas (por ejemplo, las del 25% inferior de ocupaci贸n)
