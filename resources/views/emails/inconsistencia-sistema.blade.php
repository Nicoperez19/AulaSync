...
<head>
    ...
    <title>Alerta de Inconsistencias - AulaSync</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <strong>Alerta de Inconsistencias - AulaSync</strong>
            <br>
        ...
        <div class="footer">
            <p>Este correo fue generado automáticamente por el sistema de monitoreo de AulaSync.</p>
