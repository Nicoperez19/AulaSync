...
class ConfirmacionDevolucion extends Mailable
{
    ...
    /**
     * Crea una nueva instancia del mailable a partir de una Reserva finalizada.
     */
    public function __construct(Reserva $reserva)
    {
        ...
        $this->horaDevolucion = $reserva->hora_salida
    ...
    {
        return new Envelope(
            subject: 'Confirmación de Devolución – ' . $this->idEspacio,
        );
    }
    ...
    {
        return new Content(
            view: 'emails.confirmacion-devolucion',
        );
    }
}
