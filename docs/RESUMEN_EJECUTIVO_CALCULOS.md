---
title: Resumen Ejecutivo - Cálculos del Sistema SIA | Sistema de Informaci�n de Aulas
...
**Asunto:** Metodologías de Cálculo - Sistema SIA | Sistema de Informaci�n de Aulas

---

## INDICADORES MONITOREADOS (14 Métricas)

El sistema SIA | Sistema de Informaci�n de Aulas calcula en tiempo real 14 indicadores para la gestión de espacios académicos:
