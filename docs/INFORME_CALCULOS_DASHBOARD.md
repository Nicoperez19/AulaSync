...
author: Equipo de Desarrollo - SIA | Sistema de Informaci�n de Aulas
...
**Asunto:** Descripción de Metodologías de Cálculo - Sistema SIA | Sistema de Informaci�n de Aulas  
...
El presente informe describe las metodologías de cálculo implementadas en el sistema de gestión de espacios académicos SIA | Sistema de Informaci�n de Aulas. Cada indicador ha sido diseñado para proporcionar información precisa sobre la utilización de infraestructura disponible en la sede Talcahuano.
...
El sistema SIA | Sistema de Informaci�n de Aulas implementa 14 indicadores de gestión de espacios académicos con funcionamiento operativo. Los cálculos actuales proporcionan visibilidad sobre la utilización de infraestructura.
...
**Documento Preparado por:** Equipo de Desarrollo SIA | Sistema de Informaci�n de Aulas  
**Revisión:** 2.0  
