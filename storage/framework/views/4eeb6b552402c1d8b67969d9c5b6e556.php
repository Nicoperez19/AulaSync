...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.label','data' => ['for' => 'nombre_mapa','value' => __('Nombre del Mapa')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'nombre_mapa','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Nombre del Mapa'))]); ?>
...
<?php endif; ?>
        ...
        <form id="saveMapForm" method="POST" action="<?php echo e(route('mapas.store')); ?>" enctype="multipart/form-data" class="hidden">
            <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\Users\conym\OneDrive\Documentos\GitHub\AulaSync\resources\views/layouts/maps/map_add.blade.php ENDPATH**/ ?>