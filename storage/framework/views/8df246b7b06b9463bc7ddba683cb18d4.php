<div class="p-6" wire:poll.60s>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div class="stat-card bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <div class="text-2xl font-bold text-blue-900"><?php echo e($estadisticas['total']); ?></div>
        </div>
        <div class="stat-card bg-red-50 border border-red-200 rounded-lg p-4">
            ...
            <div class="text-2xl font-bold text-red-900"><?php echo e($estadisticas['no_realizadas']); ?></div>
        </div>
        <div class="stat-card bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            ...
            <div class="text-2xl font-bold text-yellow-900"><?php echo e($estadisticas['pendientes'] ?? 0); ?></div>
        </div>
        <div class="stat-card bg-green-50 border border-green-200 rounded-lg p-4">
            ...
            <div class="text-2xl font-bold text-green-900"><?php echo e($estadisticas['justificados']); ?></div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="lg:col-span-3">
            ...
            <div class="bg-white shadow rounded-lg overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                <th class="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer w-24" 
                                    ...
                                    Fecha
                                    <!--[if BLOCK]><![endif]--><?php if($sortField === 'fecha_clase'): ?>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $clasesNoRealizadas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="table-row hover:bg-gray-50 <?php echo e($clase->estado === 'pendiente' ? 'bg-yellow-50' : ''); ?>">
                                    <td class="px-3 py-4 text-sm text-gray-900 w-24">
                                        <div class="flex items-center gap-1">
                                            <?php echo e($clase->fecha_clase->format('d/m/Y')); ?>

                                            <!--[if BLOCK]><![endif]--><?php if($clase->estado === 'pendiente'): ?>
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-900 w-32">
                                        <div class="break-words"><?php echo e($clase->profesor->name ?? 'N/A'); ?></div>
                                    </td>
                                    <td class="px-3 py-4 text-sm text-gray-900 w-40">
                                        <div class="break-words">
                                            <div class="font-medium"><?php echo e($clase->asignatura->nombre_asignatura ?? 'N/A'); ?></div>
                                            <div class="text-xs text-gray-500"><?php echo e($clase->asignatura->codigo_asignatura ?? ''); ?></div>
                                        </div>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <?php echo e($clase->id_espacio); ?>

                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <?php echo e(preg_replace('/^[A-Z]{2}\./', '', $clase->id_modulo)); ?>

                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        <div class="flex flex-col gap-1">
                                            <!--[if BLOCK]><![endif]--><?php if($clase->estado === 'no_realizada'): ?>
                                                <span class="px-2 py-1 text-xs font-semibold rounded-full bg-red-100 text-red-800">
                                                    No Realizada
                                                </span>
                                            <?php elseif($clase->estado === 'pendiente'): ?>
                                            ...
                                            <?php elseif($clase->estado === 'justificado'): ?>
                                    ...
                                    <td class="px-3 py-4 text-sm text-gray-500 w-28">
                                        <div class="break-words">
                                            <div><?php echo e($clase->hora_deteccion->format('d/m/Y')); ?></div>
                                            <div class="text-xs"><?php echo e($clase->hora_deteccion->format('H:i')); ?></div>
                                        </div>
                                    </td>
                                        ...
                                        <div class="flex space-x-1">
                                            <!--[if BLOCK]><![endif]--><?php if($clase->estado === 'no_realizada'): ?>
                                                <div class="custom-tooltip">
                                                    <button wire:click="showReagendarModal(<?php echo e($clase->id); ?>)" 
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($clase->estado === 'pendiente'): ?>
                                                <div class="custom-tooltip">
                                                    <button wire:click="marcarComoRecuperada(<?php echo e($clase->id); ?>)" 
                                            ...
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                            <div class="custom-tooltip">
                                                <button wire:click="showEditModal(<?php echo e($clase->id); ?>)" 
                                            ...
                                            <div class="custom-tooltip">
                                                <button wire:click="showDeleteModal(<?php echo e($clase->id); ?>)" 
                ...
                <!-- Paginación -->
                <!--[if BLOCK]><![endif]--><?php if($clasesNoRealizadas->hasPages()): ?>
                    <div class="px-6 py-3 border-t border-gray-200">
                        <?php echo e($clasesNoRealizadas->links()); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    Livewire.on('show-edit-modal', (data) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.Livewire.find('<?php echo e($this->getId()); ?>').call('updateClase', clase.id, estado, observaciones);
            }
        });
    });
    ...
    Livewire.on('show-reagendar-modal', (data) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.Livewire.find('<?php echo e($this->getId()); ?>').call('reagendarClase', clase.id, nuevaFecha, nuevoEspacio, nuevoModulo, motivo);
            }
        });
    });
    ...
    Livewire.on('confirm-delete', (data) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.Livewire.find('<?php echo e($this->getId()); ?>').call('confirmDelete', clase.id);
            }
        });
    });
...
<?php /**PATH D:\Dev\AulaSync\resources\views/livewire/clases-no-realizadas-table.blade.php ENDPATH**/ ?>