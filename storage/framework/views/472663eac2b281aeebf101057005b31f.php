...
<?php if($errors->any()): ?>
    <div <?php echo e($attributes); ?>>
        <div class="font-medium text-red-600">
            <?php echo e(__('¡Ups! Algo salió mal.')); ?>

        </div>
    </div>
<?php endif; ?><?php /**PATH C:\Users\conym\OneDrive\Documentos\GitHub\AulaSync\resources\views/components/auth-validation-errors.blade.php ENDPATH**/ ?>