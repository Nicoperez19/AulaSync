                                    ...
                                    <tr class="<?php echo e($index % 2 === 0 ? 'bg-white' : 'bg-gray-50'); ?> hover:bg-gray-100 transition-colors duration-200 h-10 border-b border-gray-200">
                                        <!-- Columna 1: Modulo -->
                                            <td class="px-3 py-1 text-sm align-middle border-r border-gray-200">
                                                ...
                                                <?php elseif(($espacio['tiene_reserva_profesor'] ?? false) && !empty($espacio['datos_profesor'])): ?>
                                                    <div class="font-medium text-gray-900 text-sm">
                                                        <div class="text-gray-600">
                                                            Reserva Profesor
                                                        </div>
                                                ...
                                                <?php elseif($this->moduloActual && !empty($this->moduloActual['numero'])): ?>
                                                    ...
                                                    <?php else: ?>
                                                        <div class="font-medium text-gray-900 text-sm">
                                                            <!--[if BLOCK]><![endif]--><?php if(!empty($espacio['rango_disponibilidad'])): ?>
                                                                <div class="flex items-center gap-2 text-base font-semibold text-green-600">
                                                                    <?php echo e($espacio['rango_disponibilidad']['desde']); ?> - <?php echo e($espacio['rango_disponibilidad']['hasta']); ?>

                                                                </div>
                                                                <div class="text-gray-600">
                                                                    <?php echo e(substr($espacio['rango_disponibilidad']['hora_desde'], 0, 5)); ?> - <?php echo e(substr($espacio['rango_disponibilidad']['hora_hasta'], 0, 5)); ?>
                                                            ...
                                                            <?php else: ?>
                                                                ...
                                                                <div class="text-gray-600">
                                                                    <?php echo e(substr($this->moduloActual['inicio'], 0, 5)); ?> - <?php echo e(substr($this->moduloActual['fin'], 0, 5)); ?>
                                        ...
                                        <td class="px-3 py-1 text-sm align-middle border-r border-gray-200">
                                            ...
                                            <?php elseif(($espacio['tiene_reserva_profesor'] ?? false) && !empty($espacio['datos_profesor']['carrera'])): ?>
                                                <span class="font-medium text-gray-700 text-sm"><?php echo e($espacio['datos_profesor']['carrera']); ?></span>
                                            <?php else: ?>
                                                <span class="text-gray-400 italic text-sm">-</span>
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        </td>
