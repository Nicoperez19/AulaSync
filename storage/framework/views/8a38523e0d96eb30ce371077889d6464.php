...
<?php $component->withAttributes([]); ?>
    ...
    <div class="px-6 min-h-[80vh]">
            ...
            <form id="filtro-letra-form" method="GET" action="" class="flex flex-col gap-4" onsubmit="return false;">
                ...
                <div class="flex flex-col w-full gap-4 lg:flex-row lg:items-center lg:justify-center">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <select name="semestre" id="semestre-filtro"
                            ...
                            <?php $__currentLoopData = $semestresDisponibles ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $semestre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($semestre); ?>" <?php echo e(request('semestre', \App\Helpers\SemesterHelper::getCurrentSemester()) == $semestre ? 'selected' : ''); ?>>
                                    <?php echo e($semestre); ?>° Semestre</option>
                    ...
                    <div class="flex items-center flex-1 gap-2">
                        <div class="relative w-full">
                            <input type="text" name="search" id="search-profesor" value="<?php echo e(request('search')); ?>"
                ...
                <div class="flex flex-col w-full gap-2 sm:flex-row sm:items-center">
                    ...
                    <div class="flex flex-wrap items-center gap-1">
                        ...
                        ?>
                        <?php $__currentLoopData = $letras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $letra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button type="button"
                                class="<?php echo e($letra === 'Todos' ? 'w-16' : 'w-8'); ?> h-8 flex items-center justify-center rounded border text-xs font-bold uppercase focus:outline-none letra-filtro-btn transition
                                    <?php echo e($letraSeleccionada == $letra ? 'bg-light-cloud-blue text-white' : 'bg-white text-light-cloud-blue  hover:bg-light-cloud-blue/10'); ?>"
                                data-letra="<?php echo e($letra); ?>"><?php echo e($letra); ?></button>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <input type="hidden" name="letra" id="letra-filtro-input" value="<?php echo e($letraSeleccionada); ?>">
        ...
        <div id="profesores-lista">
            <div class="flex flex-col justify-between mb-4 sm:flex-row sm:items-center">
                <p class="text-sm text-gray-500"><?php echo e($profesores->total()); ?> profesores encontrados</p>
                <?php
                ...
                <p class="text-sm font-semibold text-light-cloud-blue">
                    ...
                    Período: <?php echo e($semestreMostrar); ?>er Semestre <?php echo e($anioMostrar); ?>
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-6">
                <?php $__currentLoopData = $profesores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profesor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        data-run="<?php echo e($profesor->run_profesor); ?>">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex flex-col">
                                <span class="text-base font-bold text-gray-900 uppercase"><?php echo e($profesor->name); ?></span>
                            </div>
                        </div>
            ...
            <div class="mt-6">
                <?php echo e($profesores->appends(request()->query())->links()); ?>
            ...
            <div
                ...
                <div
                    ...
                    <p class="mb-1 text-xs text-center text-gray-600" id="modalPeriodo">
                        <i class="mr-1 fa-solid fa-calendar-days"></i>
                        Período: <span id="modalSemestre"><?php echo e($semestreMostrar); ?></span>er Semestre <span
                            id="modalAnio"><?php echo e($anioMostrar); ?></span>
                    </p>
                </div>
    ...
    <script>
        ...
        searchInput.addEventListener('input', debounce(function () {
            ...
            const url = `<?php echo e(route('horarios.index')); ?>?search=${encodeURIComponent(search)}`;
            ...
            fetch(url)
                ...
                .then(data => {
                    ...
                    if (data.mensaje) {
                        ...
                        document.getElementById('modalSemestre').textContent = semestreFiltro || '<?php echo e(\App\Helpers\SemesterHelper::getCurrentSemester()); ?>';
        ...
        limpiarFiltroBtn.addEventListener('click', function() {
            ...
            const semestreActual = '<?php echo e(\App\Helpers\SemesterHelper::getCurrentSemester()); ?>';
...
<?php endif; ?><?php /**PATH D:\Dev\AulaSync\resources\views/layouts/schedules/schedules_index.blade.php ENDPATH**/ ?>