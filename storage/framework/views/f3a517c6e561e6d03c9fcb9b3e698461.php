...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['variant' => 'add','class' => 'max-w-xs gap-2','xOn:click.prevent' => '$dispatch(\'open-modal\', \'add-configuracion\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'add','class' => 'max-w-xs gap-2','x-on:click.prevent' => '$dispatch(\'open-modal\', \'add-configuracion\')']); ?>
...
[$__name, $__params] = $__split('configuracion-table', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-1309326061-0', $__slots ?? [], get_defined_vars());
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'add-configuracion','show' => $errors->any(),'focusable' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'add-configuracion','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->any()),'focusable' => true]); ?>
            ...
            <form method="POST" action="<?php echo e(route('configuracion.store')); ?>" class="p-6">
                <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.input','data' => ['id' => 'clave','name' => 'clave','type' => 'text','class' => 'w-full @error(\'clave\') border-red-500 @enderror','required' => true,'maxlength' => '100','placeholder' => 'Ej: logo_institucional','value' => ''.e(old('clave')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'clave','name' => 'clave','type' => 'text','class' => 'w-full @error(\'clave\') border-red-500 @enderror','required' => true,'maxlength' => '100','placeholder' => 'Ej: logo_institucional','value' => ''.e(old('clave')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        <textarea id="valor" name="valor" rows="3"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 <?php $__errorArgs = ['valor'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" 
                            required><?php echo e(old('valor')); ?></textarea>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginal5c2a97ab476b69c1189ee85d1a95204b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5c2a97ab476b69c1189ee85d1a95204b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.input','data' => ['id' => 'descripcion','name' => 'descripcion','type' => 'text','class' => 'w-full @error(\'descripcion\') border-red-500 @enderror','maxlength' => '255','placeholder' => 'Descripción de la configuración','value' => ''.e(old('descripcion')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('form.input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'descripcion','name' => 'descripcion','type' => 'text','class' => 'w-full @error(\'descripcion\') border-red-500 @enderror','maxlength' => '255','placeholder' => 'Descripción de la configuración','value' => ''.e(old('descripcion')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5c2a97ab476b69c1189ee85d1a95204b)): ?>
<?php $attributes = $__attributesOriginal5c2a97ab476b69c1189ee85d1a95204b; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'success']); ?><?php echo e(__('Crear Configuración')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561)): ?>
<?php $attributes = $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561; ?>
<?php unset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\conym\OneDrive\Documentos\GitHub\AulaSync\resources\views/layouts/configuracion/configuracion_index.blade.php ENDPATH**/ ?>