...
<?php endif; ?>
            ...
            <div class="flex flex-col items-center justify-center w-full max-w-md p-1 mx-auto">
                ...
                <!-- Enlace Volver (solo si no es el usuario 00000000) -->
                <?php if(auth()->user()->run !== '00000000'): ?>
...
<?php endif; ?>
<?php /**PATH D:\Dev\AulaSync\resources\views/layouts/plano_digital/show.blade.php ENDPATH**/ ?>